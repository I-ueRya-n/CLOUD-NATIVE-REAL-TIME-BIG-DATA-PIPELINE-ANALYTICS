...
This is added to using a httptrigger route , which allows requests to be stored in ``topic'' queues. 
...
I NEED TO TALK ABOUT AUTOSCALING HERE
...
\paragraph*{OpenAustralia} 
A modular approach to functions was taken to handle errors in the OpenAustralia API.\ 
