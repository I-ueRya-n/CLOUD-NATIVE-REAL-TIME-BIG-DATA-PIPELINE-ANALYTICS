...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{report_images/wordcloud-person.png}
    \caption{Word cloud of the most common ``Person'' entities mentioned in the posts and debates.}
    \label{fig:word-org}
\end{figure}
...
\subsubsection*{Comparing the topics over time: count of keyword frequency over time}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.35]{report_images/housing-keyword-count.png}
    \caption{Frequency of the keyword ``housing'' over time across platforms.}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{report_images/sentiment-over-time-bs-reddit.png}
    \caption{Overall averaged sentiment of Bluesky and Reddit posts from 1st to the 19th of May 2025.}
    \label{fig:word-org}
\end{figure}
...
For example, from the 1st to the 19th of May 2025, bluesky posts averaged a negative sentiment of around 7\%, while the average negative sentiment of reddit posts ranged from 5\% to 9\%. 
Both BlueSky and Reddit posts were generally mostly neutral, but slightly more positive than negative.


\subsubsection*{Comparing sentiment by topic: stacked bar chart of averaged sentiment}
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.35]{report_images/sentiment-pauline.png}
    \caption{Comparison of sentiment of posts discussing ``Pauline Hanson'' and debates where ``Pauline Hanson'' was a speaker.}
\end{figure}
...
Due to the smaller number of posts collected on reddit, these differences were more pronounced.

For the online platforms, the sentiment was averaged over posts discussing the topic.
...
For example, the sentiment of posts discussing ``Pauline Hanson'' was compared to the sentiment of debates where ``Pauline Hanson'' was a speaker. 
